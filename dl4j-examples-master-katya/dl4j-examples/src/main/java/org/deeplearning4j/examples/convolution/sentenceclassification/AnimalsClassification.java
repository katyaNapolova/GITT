...
public class AnimalsClassification {
    ...
    protected static int numExamples = 1500;
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
    ...
    public MultiLayerNetwork lenetModel() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .list()
            .layer(0, convInit("cnn1", channels, 50,  new int[]{4, 4}, new int[]{1, 1}, new int[]{0, 0}, 0))
            .layer(1, maxPool("maxpool1", new int[]{2,2}))
            .layer(2, conv2x2("cnn4*2*2", 200,  0))
            .layer(3, maxPool("maxool4", new int[]{2,2}))
            .layer(4, conv3x3("cnn33*3", 100, 0))
    ...
    public MultiLayerNetwork alexnetModel() {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .l2(5 * 1e-4)
            .list()
            .layer(0, convInit("cnn1", channels, 60, new int[]{4, 4}, new int[]{4, 4}, new int[]{3, 3}, 0))
